...
const TempusDominusBootstrap4 = ($ => { // eslint-disable-line no-unused-vars
    ...
    class TempusDominusBootstrap4 extends DateTimePicker {
        ...
        _getDatePickerTemplate() {
            ...
            return [$('<div>').addClass('datepicker-days table-responsive').appe($('<table>').addClass('table table-borderless table-sm').append(headTemplate).append($('<tbody>'))), $('<div>').addClass('datepicker-months').append($('<table>').addClass('table-condensed').append(headTemplate.clone()).append(contTemplate.clone())), $('<div>').addClass('datepicker-years').append($('<table>').addClass('table-condensed').append(headTemplate.clone()).append(contTemplate.clone())), $('<div>').addClass('datepicker-decades').append($('<table>').addClass('table-condensed').append(headTemplate.clone()).append(contTemplate.clone()))];
        }
